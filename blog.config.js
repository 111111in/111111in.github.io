...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '306eafb2254281998dd2f335f60f00db',
  ...
  AUTHOR: 'llllllin', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || "Hi, I'm llllllin. A sophomore at Nanchang University, passionate about full-stack development 🍎", // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://111111in.github.io', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '赣ICP备2025066072号-2', // 备案号 闽ICP备XXXXXX
